...
---------------------
Let's create a new **server.js** file that we will use to show the basic CRUD operations using the MongoDB driver.
...
We can now run the update **server.js** file.

```
node server.js
```

You should see the following output after running the **server.js** file.
