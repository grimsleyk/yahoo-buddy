/**
 * Created by kevin
 * Description: Sets up the node configuration for yahoo-buddy
 */
...
// Include Controllers
var nerdController = require('./server/controllers/NerdController');

// Register controller routes on router
nerdController.register(apiRouter);
